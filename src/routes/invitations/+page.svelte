						...
						<div class="flex flex-col items-start justify-between gap-6 md:flex-row">
							...
							<div class="flex w-full flex-col gap-2 sm:flex-row md:w-auto md:flex-col">
								<form method="POST" action="?/accept" use:enhance class="w-full sm:w-auto">
									...
									<button
										type="submit"
										class="w-full rounded-lg bg-green-600 px-6 py-2.5 font-medium text-white transition-colors hover:bg-green-700 sm:w-auto"
									>
										Accept
									</button>
								</form>
								...
								<form method="POST" action="?/decline" use:enhance class="w-full sm:w-auto">
									...
									<button
										type="submit"
										class="w-full rounded-lg border-2 border-gray-300 bg-white px-6 py-2.5 font-medium text-gray-700 transition-colors hover:bg-gray-50 sm:w-auto"
									>
										Decline
									</button>
								</form>
