...
<Modal {isOpen} title="Transfer Project Ownership" on:close={handleClose}>
	<form method="POST" action="?/transferOwnership" on:submit={handleSubmit} class="space-y-6">
		...
		<div class="space-y-2">
			...
			<select
				...
				class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-gray-900 shadow-sm transition-colors focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-50"
			>
		...
		<div class="space-y-2">
			...
			<input
				...
				class="block w-full rounded-lg border border-gray-300 px-4 py-2.5 shadow-sm transition-colors focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-50"
			/>
		</div>
